      ...
      <!-- Table -->
		<table class="table"> 
            ...
            <?php if (@$items_number >= 1){ // if order have one item or more loop in it and make a list of items in cart
				...
				while($item = mysqli_fetch_array($cart_data)){
				 ...
				 ?>
                <tr> <th scope="row"><?=$n?></th> <td><?=$item['item_name']?></td> <td><?=$item['quantity']?></td> <td><?=$item['price']?>$</td> <td><a href="b.php?do=delete&id=<?=$item['id']?>"><span class="btn btn-danger" >remove </span></a>   <a href="b.php?do=add_one&id=<?=$item['id']?>"><span class="btn btn-success" >+ </span></a> <a href="b.php?do=remove_one&id=<?=$item['id']?>"><span class="btn btn-warning" >- </span></a>  </td> </tr>
                <?php
				$n++;
				$total +=$item['price'];
				 }}?>
        ...
        <div class="panel-footer" >
        	<div class="btn-group col-md-4" role="group">
              <a href="b.php?do=delete_all"><span class="btn btn-default col-md-8" >empty cart</span></a>
 
          </div>
          <div class="btn-group col-md-4" role="group">
          	<a href="submit.php"><span class="btn btn-default col-md-8" >submit order</span></a>
          </div>
...
<div class="panel panel-default">
     <div class="panel-heading item_name">NOODLES</div>
  <div class="panel-body">
 <img src="img/noodles.jpg" class="img-thumbnail img-responsive item_thumb"><br> 
     Description<span class='row'></span>
  </div>
  <div class="panel-footer"> <p class="item_price">$ 30</p>
 ...
 <div class="col-md-3 simpleCart_shelfItem">   
<div class="panel panel-default">
     <div class="panel-heading item_name">SPRING ROLL</div>
  <div class="panel-body">
 <img src="img/springroll.jpg" class="img-thumbnail img-responsive item_thumb"><br>Description
  </div>
  <div class="panel-footer"><p class="item_price">$ 138</p>  
    <form method="post" action="?do=add" >
  <input type="submit" class='btn btn-danger btn-md item_add' value="ADD" >
    <label>Qty: <input class="item_Quantity form-control" type="text" name="quantity" value="1"></label>
    <input type="hidden" name="item_number" value="2">
    <input type="hidden" name="item_name" value="springroll">  
         <input type="hidden" name="item_price" value="138"> 
    </form>  
    </div>
</div>
     ...
     <div class="col-md-3 simpleCart_shelfItem">   
<div class="panel panel-default">
     <div class="panel-heading item_name">SANDWICH</div>
  <div class="panel-body">
  <img src="img/sandwich.jpeg" class="img-thumbnail img-responsive item_thumb"><br>Description
  </div>
  <div class="panel-footer"><p class="item_price">$ 80</p> 
    <form method="post" action="?do=add" >
  <input type="submit" class='btn btn-danger btn-md item_add' value="ADD" >
  <label>Qty: <input class="item_Quantity form-control" type="text"  name="quantity" value="1"></label>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  <img src="img/pasta.jpg" class="img-thumbnail img-responsive item_thumb"><br>Description
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  <img src="img/momo.jpg" class="img-thumbnail img-responsive item_thumb"><br>Description
  </div>
