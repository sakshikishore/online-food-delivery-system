      ...
      <!-- Table -->
		<table class="table"> 
            ...
            <?php if (@$items_number >= 1){ // if order have one item or more loop in it and make a list of items in cart
				...
				while($item = mysqli_fetch_array($cart_data)){
				 ...
				 ?>
                <tr> <th scope="row"><?=$n?></th> <td><?=$item['item_name']?></td> <td><?=$item['quantity']?></td> <td><?=$item['price']?>$</td> <td><a href="t.php?do=delete&id=<?=$item['id']?>"><span class="btn btn-danger" >remove </span></a>   <a href="t.php?do=add_one&id=<?=$item['id']?>"><span class="btn btn-success" >+ </span></a> <a href="t.php?do=remove_one&id=<?=$item['id']?>"><span class="btn btn-warning" >- </span></a>  </td> </tr>
                <?php
				$n++;
				$total +=$item['price'];
				 }}?>
        ...
        <div class="panel-footer" >
        	<div class="btn-group col-md-4" role="group">
              <a href="t.php?do=delete_all"><span class="btn btn-default col-md-8" >empty cart</span></a>
...
<div class="panel panel-default">
     <div class="panel-heading item_name">PIZZA </div>
  <div class="panel-body">
 <img src="img/pizza.jpg" class="img-thumbnail img-responsive item_thumb"><br> 
 ...
 <div class="col-md-3 simpleCart_shelfItem">   
<div class="panel panel-default">
     <div class="panel-heading item_name">HALWA</div>
  <div class="panel-body">
 <img src="img/halwa.jpeg" class="img-thumbnail img-responsive item_thumb"><br>Description
  </div>
  ...
  <input type="submit" class='btn btn-danger btn-md item_add' value="ADD" >
    ...
    <input type="hidden" name="item_name" value="halwa">  
     ...
     <div class="col-md-3 simpleCart_shelfItem">   
<div class="panel panel-default">
     <div class="panel-heading item_name">BURGER</div>
  <div class="panel-body">
  <img src="img/burger.jpeg" class="img-thumbnail img-responsive item_thumb"><br>Description
  </div>
